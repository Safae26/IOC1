...
public class Pres1 {
    public static void main(String[] args) {
        ...
        DaoImplV2 dao = new DaoImplV2(); // Cette classe Pres1 n'est pas fermée à la modification : couplage fort <-> fait appel à des classes, donc ce n'est pas encore parfait!
